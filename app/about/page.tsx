      ...
      <div className="mt-6 grid gap-6">
        ...
        <div className="rounded-[1.75rem] border border-amber-300/80 bg-amber-50 p-6 dark:border-amber-900/50 dark:bg-amber-900/20">
          ...
          <p className="text-orange-900 text-sm leading-relaxed">
            ...
            the Rastriya Swatantra Party (RSP) or any other political party,
            government body, or official institution. All information is
            published for civic transparency and educational purposes only.
            While we strive for accuracy, errors may exist — verify important
